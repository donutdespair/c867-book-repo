...
private:
    ...
    Book* bookRepoArray[numBooks]; //not decalred dynamically
...
public:
    ...
    void printAveragePrices();//prints average price for each book
    void removeBookByID(string bookID);//find book and remove
    ~Repo();//destructor
